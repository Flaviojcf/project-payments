using Expert.Domain.IntegrationEvents;
...
namespace Expert.Application.Consumers
{
    public class PaymentApprovedConsumer : BackgroundService
    {
        ...
        protected override Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            consumer.Received += async (sender, eventArgs) =>
            {
                ...
                var paymentApprovedIntegrationEvent = JsonSerializer.Deserialize<PaymentApprovedntegrationEvent>(paymentApprovedJson);
